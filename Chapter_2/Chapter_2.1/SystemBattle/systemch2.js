...
function showDifficultyButtons() {
    document.getElementById('buttonContainer').innerHTML = `
        ...
        <button onclick="startQuiz('medium', 10, 5)">Medium</button>
        <button onclick="startQuiz('hard', 25, 5)">Hard</button>
    `;
}
...
function checkAnswer(correctAnswer, damage, cost) {
    ...
    if (userAnswer === correctAnswer) {
        ...
        document.getElementById('playerGif').src = './MC_Sprites/Attack.png';
        document.getElementById('enemyGif').src = 'demonhurt.png';
        ...
        document.getElementById('enemyGif').src = 'PiglinPNG.png';
        document.getElementById('playerGif').src = './MC_Sprites/demonattack.png';
    ...
    setTimeout(() => {
        ...
        document.getElementById('enemyGif').src = 'demonidle.png';
...
function nextStage() {
    ...
    window.location = "../../../Chapter_3/SystemBattle/Chapte_3.1/BattleSystemCh3.1.html";
}
